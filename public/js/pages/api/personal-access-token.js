...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash__ = __webpack_require__(38);
    ...
    methods: {
        ...
        store: function store() {
            ...
            axios.post('/oauth/personal-access-tokens', this.form).then(function (response) {
                ...
                if (_typeof(error.response.data) === 'object') {
                    _this3.form.errors = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.flatten(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.toArray(error.response.data));
                } else {
        ...
        toggleScope: function toggleScope(scope) {
            if (this.scopeIsAssigned(scope)) {
                this.form.scopes = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.reject(this.form.scopes, function (s) {
                    return s == scope;
                });
            } else {
        ...
        scopeIsAssigned: function scopeIsAssigned(scope) {
            return __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.indexOf(this.form.scopes, scope) >= 0;
        },
